...
<!doctype html><html lang="id"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Kelola Admin</title><link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600&family=Playfair+Display:wght@400;700;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="../css/style.css"></head>
<body class="role-admin">
  ...
  <main class="container admin-main">
    <h1>Kelola Admin</h1>
    <div class="card"><p>Tambah user admin (statik). Untuk produksi, buat tabel `admins` dan autentikasi. Sample admin exists: admin@example.com</p></div>
  </main>
